...
(function e(t, n, r) {
    function s(o, u) {
        ...
        var API = require('./util/webhose.js');
        ...
        $(document).ready(function () {
            ...
            function fetchNews(string) {
                $main.html('...loading');
                API.fetchRender(string).then(function (output) {
                    return $main.html(output);
                }).catch(function (err) {
                    return $main.html(err);
                });
            }
        });
    }, { "./util/webhose.js": 31, "axios": 1 }], 30: [function (require, module, exports) {
        var helpers = module.exports = {};

        helpers.truncate = function (string, num) {
            var sliced = string.slice(0, num);
            return sliced + "...";
        };
    }, {}], 31: [function (require, module, exports) {
        var webhose = module.exports = {};
        ...
        var endpoint = "" + baseURL + APIKEY + "&format=json&sort=relevancy&size=250&q=";

        webhose.query = function (string) {
            var queryParam = encodeURI(string);
            var url = "" + endpoint + queryParam + "%20language%3Aenglish%20site_type%3Anews";
        ...
        webhose.parsePost = function (post) {
            ...
            var text = helpers.truncate(post.text, 250);
            var thread = post.thread || {};
            var site = thread.site;
            var published = moment(thread.published).format('DD/MM/YY');
            return "\n    <div class=\"post\">\n      <h3>" + title + "</h3>\n      <p>Site: <a href=\"" + url + "\" target=\"_blank\">" + site + "</a> | Published: " + published + "</p>\n      <p>" + text + "</p>\n    </div>\n  ";
        };

        webhose.fetchRender = function (string) {
            return webhose.query(string).then(function (response) {
    ...
    }, { "./helpers": 30, "axios": 1, "moment": 27 }] }, {}, [29]);
